...
public class Station_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        photo.setImage(ImageSource.resource(R.drawable.kuba));
        photo.setMinimumScaleType(SCALE_TYPE_CENTER_CROP);
        info.setText(R.string.station3);
        which_station = findViewById(R.id.which_station);
        which_station.setText(R.string.kuba);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Station_3.this, MainActivity.class);
        if (Tools.STATIONS[2] == false) {
            Tools.NEXT_STATION += 1;
            Tools.STATIONS[2] = true;
        }
